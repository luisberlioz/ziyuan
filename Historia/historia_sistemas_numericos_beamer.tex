...
\begin{frame}{Artefactos y geometría}
  ...
  \caption{Stonehenge al amanecer del solsticio de verano (21 jun 2005), alineación solar. By Andrew Dunn - https://commons.wikimedia.org/wiki/File:Summer\_Solstice\_2005\_Sunrise\_over\_Stonehenge\_01.jpg}
\end{figure}
  \end{center}
\end{frame}
...
\begin{frame}{Tablillas famosas y legado moderno}
  ...
  \caption{Tablilla Plimpton 322 (~1800 BCE): triadas pitagóricas en notación sexagesimal. By photo author unknown - https://commons.wikimedia.org/wiki/File:Plimpton\_322.jpg}
\end{figure}
  \end{center}
\end{frame}
...
\begin{frame}{Numeración hierática}
  ...
  \caption{Papiro matemático Rhind (c. ~1650 BCE), detalle con numeración hierática. By Trustees of the British Museum - https://commons.wikimedia.org/wiki/File:Rhind\_Mathematical\_Papyrus.jpg}
\end{figure}
  \end{center}
\end{frame}
...
\begin{frame}{Mapa cronológico}
  ...
  \begin{center}
    \begin{figure}
        \includegraphics[width=0.85\textwidth]{images/olmeca1.jpg}
  \caption{Región cultural de Mesoamérica. By Alex Covarrubias - https://commons.wikimedia.org/wiki/File:Region\_Mesoamerica.png}
\end{figure}
  \end{center}
\end{frame}
...
\begin{frame}{Calendarios y cero}
  ...
  \caption{Estela 1 de La Mojarra: glifos con fecha de Cuenta Larga 8.5.16.9.7 (~156 CE). By Maunu - https://commons.wikimedia.org/wiki/File:La\_Mojarra\_Inscription\_and\_Long\_Count\_date.jpg}
\end{figure}
  \end{center}
\end{frame}
...
\begin{frame}{Fuentes y comparación}
  ...
  \caption{Códice Mendoza, folio 46r: tributos al imperio azteca. By El Comandante - https://commons.wikimedia.org/wiki/File:Codex\_Mendoza\_folio\_46r.jpg}
\end{figure}
  \end{center}
  \vspace{0.2cm}
...
\begin{frame}{Símbolos Unicode (U+1D2E0--U+1D2F9)}
  \begin{itemize}
    \item Bloque Unicode \textit{Mayan Numerals}: 20 glifos (0--19)
    \item Fuente: \texttt{Symbola} (renderizado desde PUA plano 1)
  \end{itemize}
  \vspace{0.2cm}
  \begin{center}
  \begin{tabular}{ccccc}
    \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E0.png}}\,{\scriptsize 0} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E1.png}}\,{\scriptsize 1} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E2.png}}\,{\scriptsize 2} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E3.png}}\,{\scriptsize 3} \\
    \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E4.png}}\,{\scriptsize 4} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E5.png}}\,{\scriptsize 5} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E6.png}}\,{\scriptsize 6} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E7.png}}\,{\scriptsize 7} \\
    \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E8.png}}\,{\scriptsize 8} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2E9.png}}\,{\scriptsize 9} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2EA.png}}\,{\scriptsize 10} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2EB.png}}\,{\scriptsize 11} \\
    \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2EC.png}}\,{\scriptsize 12} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2ED.png}}\,{\scriptsize 13} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2EE.png}}\,{\scriptsize 14} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2EF.png}}\,{\scriptsize 15} \\
    \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2F0.png}}\,{\scriptsize 16} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2F1.png}}\,{\scriptsize 17} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2F2.png}}\,{\scriptsize 18} & \raisebox{-0.3\height}{\includegraphics[height=0.7cm]{images/maya_unicode/maya_1D2F3.png}}\,{\scriptsize 19} \\
  \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{Uso, especialistas y escala}
  ...
  \caption{Quipu inka del Museo Arqueológico Rafael Larco Herrera (Lima, Perú). By Museo Arqueológico Rafael Larco Herrera - https://commons.wikimedia.org/wiki/File:Inca\_Quipu.jpg}
\end{figure}
  \end{center}
\end{frame}
