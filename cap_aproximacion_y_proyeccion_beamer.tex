...
\begin{frame}{Aproximación por mínima norma: definición}
  ...
  \begin{tikzpicture}[overlay,remember picture]
    \node[draw=accentorange,fill=accentorange!10,align=left] at
      ([xshift=-3.6cm,yshift=-0.5cm]current page.east) {%
        \footnotesize
        mínimo: \\[-0.2em]\footnotesize mira $\xb$ como dato \\[-0.2em]\footnotesize y $\x$ como a minimizar}; 
  \end{tikzpicture}
\end{frame}
